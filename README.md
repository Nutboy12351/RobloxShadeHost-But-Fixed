...
Use ReShade with Roblox by installing it on RobloxShadeHost. Download the EXE, install ReShade on it, and run it alongside Roblox.
...
The host receives Roblox's visible image, without its depth buffer. Effects that require game depth, such as many ambient occlusion and depth-of-field shaders, will not work as intended. Full add-on support does not add Roblox depth data.
